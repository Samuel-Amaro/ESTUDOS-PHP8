...
try {
    ...
    INNER JOIN country AS pais ON cidade.country_id = pais.country_id AND pais.country = :nome_pais;'; 
    $objetoPdoStatment = $dbh->prepare($sqlValido);
    /*variavel que contem o valor do paramentro de posição nomeado na SQL instrução*/
    $nomePais = 'Brazil';
    /*Vincula um parâmetro ao nome da variável especificada, vincula o paramentro de posição nomeado :nome_pais que esta dentro da consulta preparada SQL,  a variavel $nomePais, sendo que essa variavel e do tipo string*/
    $objetoPdoStatment->bindParam(":nome_pais", $nomePais, PDO::PARAM_STR);
...
?>
    ...
    <body>
        ...
        <h5>Cidades aleatorias do brazil</h5>
        <table>
            <tr>
                <th>Cidade</th>
                <th>Pais</th>
