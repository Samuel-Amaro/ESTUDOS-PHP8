...
/**
 * * EXEMPLO #1 EXECUTE UMA INSTRUÇÃO PREPARADA COM MARCADORES DE POSIÇÃO NOMEADOS
 * 
 * 
*/
...
try {
    ...
    $primeiraLetraNome = 'K';
    /*vincula o valor da varivel $primeiraLetraNome ao paramentro de posição nomeado :primeira_letra_nome na instrução SQL preparada, especificando dois caracteres curingas para serem utilizados juntamente com o LIKE, o valor do paramentro e do tipo string, especificamos isso com uma string*/
    $objetoPdoStatment->bindValue(':primeira_letra_nome',  "%{$primeiraLetraNome}%", PDO::PARAM_STR);
...
?>
    ...
    <body>
        ...
        <h5>Nomes de atores que começam com a letra k</h5>
        <table>
            <tr>
                <th>Id Ator</th>
                <th>Primeiro Nome</th>
