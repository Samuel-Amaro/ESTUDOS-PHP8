...
/**
 * * EXEMPLO #1 EXIBINDO CAMPOS errorInfo() para uma conexão PDO_DRIVER com um banco deados DB2 
*/
...
try {
    ...
    /*Provocar um erro - sintaxe SQL falsa*/
    $stmt = $dbh->prepare("DELETE FROM fruit");
    //$stmt pode ser um objeto PDOStatement ou false
    //negação de false e true(isso e se retornou false e porque deu erro) nega essa intrução para ser verdade e executar o tratamento do erro
    if(!$stmt) {
